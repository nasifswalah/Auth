...
import { forget_password, login, logout, signup, verifyEmail } from '../controllers/auth.controller.js';
...
router.post('/forget-password', forget_password); // Route for user verification
